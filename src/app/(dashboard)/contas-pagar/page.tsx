...
import { ClipboardList, Wallet, CheckCircle2, AlertTriangle, Clock, ChevronRight, Loader2, RefreshCw, TrendingDown, Inbox } from 'lucide-react'
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {[
                ...
                { href: '/contas-pagar/boletos',     icon: Inbox,         label: 'Boletos e Solicitações', desc: 'Recebidos do Fiscal e Marketing',  color: 'text-orange-600 bg-orange-50' },
              ].map(item => (
