-- =====================================================================
-- 016_skip_weekends.sql
-- Atualiza as funções de geração de tarefas para ignorar fins de semana
-- Sábado = DOW 6 | Domingo = DOW 0
-- Execute no Supabase SQL Editor
-- =====================================================================

-- ── 1. gerar_tarefas_conciliacao (geração automática) ────────────────
-- Se a data de referência (hoje - carência) cair em sábado ou domingo,
-- nenhuma tarefa é gerada para aquele dia.
...
-- ── 2. gerar_tarefas_proximo_dia (geração manual pelo conciliador) ────
-- Se o próximo dia calculado cair em fim de semana, avança
-- automaticamente para a segunda-feira seguinte.
